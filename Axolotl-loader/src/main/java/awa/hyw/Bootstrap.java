...
import awa.hyw.common.BMWClassLoader;
...
public class Bootstrap {
    ...
    private static final Path assetsDir = Path.of("C:", "ProgramData", "Axolotl", "runtime_assets");
    ...
    public static void agentmain(String agentArgs, Instrumentation inst) {
        try {
            ...
            System.out.println("Successfully loaded Axolotl!");
        } catch (Exception e) {
            System.err.println("Failed to load Axolotl: " + e.getMessage());
    ...
    public static void agentmain0(String agentArgs, Instrumentation inst) throws Exception {
        ...
        if (jsonObject.has("statusPort")) {
            ...
            // 设置为系统属性，Core可以读取
            System.setProperty("Axolotl.status.port", String.valueOf(statusPort));
        ...
        try {
            Class.forName("awa.hyw.Axolotl.Entry", true, finalClassLoader)
    ...
    public static void premain(String loaderSrcPath, Instrumentation inst) throws Exception {
        ...
        jsonObject.addProperty("file", loaderSrcPath + "\\build\\libs\\Axolotl Inject.jar");
