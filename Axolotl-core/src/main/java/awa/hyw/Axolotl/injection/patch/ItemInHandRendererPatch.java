...
import awa.hyw.Axolotl.injection.accessor.ItemInHandRendererAccessor;
...
import awa.hyw.patchify.annotation.Slice;
...
public class ItemInHandRendererPatch {
    ...
    public static void itemRendererHook(ItemInHandRenderer instance, AbstractClientPlayer player,
        ...
        if (!Animations.INSTANCE.shouldBlock()) return;
        if (hand == InteractionHand.MAIN_HAND) {
            ...
            if (Animations.INSTANCE.getSwordBlocking()) equip = equipProgress;
    ...
    public static void tick(ItemInHandRenderer instance, CallbackInfo ci) {
        ...
        if (!Animations.INSTANCE.shouldBlock() || !Animations.INSTANCE.getSwing()) return;
