...
public final class ASMUtil implements Opcodes {
    ...
    public static void printOpcodesWithParameters(MethodNode methodNode, Consumer<String> log) {
        ...
        for (AbstractInsnNode abstractInsn : methodNode.instructions) {
            ...
            // Print opcode and instruction type
    ...
    // Helper: convert opcode value to name
    private static String getOpcodeName(int opcode) {
        try {
            // Use reflection to get opcode name from Opcodes class
    ...
    // Helper: parse instruction parameters
