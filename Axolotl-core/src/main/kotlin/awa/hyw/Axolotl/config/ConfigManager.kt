package awa.hyw.Axolotl.config
...
import awa.hyw.Axolotl.config.impl.*
import java.io.File
...
object ConfigManager {
    ...
    private val dir = File(mc.gameDirectory, "Axolotl")
    ...
    private fun loadConfig(name: String) {
        ...
        executor.execute {
            val file = File(dir, "$name.Axolotl")
            if (file.exists()) {
                runCatching {
    ...
    fun shutdown() {
        ...
        try {
            Thread.sleep(500) // Wait for configs to save
