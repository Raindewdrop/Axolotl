...
public class EncryptUtil {
    ...
    public static byte[] encodeInt(int number) {
        ...
        result[0] = (byte) (encryptedInt >>> 24); // 取最高位
        result[1] = (byte) (encryptedInt >>> 16); // 取次高位
        result[2] = (byte) (encryptedInt >>> 8);  // 取次低位
        result[3] = (byte) encryptedInt;          // 取最低位
        return result;
    }
