...
public class MergeTask extends DefaultTask {
    ...
    public void run() throws IOException {
        ...
        try (ZipInputStream loaderZip = new ZipInputStream(new FileInputStream(loader));
                ...
                InputStream coreFileProvider = MergeTask.class.getResourceAsStream("/awa/hyw/encrypt/SimpleCoreFileProvider.class");
            ...
            cn.methods.forEach(m -> {
                m.instructions.forEach(it -> {
                    if (it instanceof MethodInsnNode methodInsnNode && methodInsnNode.owner.equals("awa/hyw/encrypt/SimpleCoreFileProvider")) {
                        methodInsnNode.owner = "awa/hyw/CoreFileProvider";
                    } else if (it instanceof FieldInsnNode fieldInsnNode && fieldInsnNode.owner.equals("awa/hyw/encrypt/SimpleCoreFileProvider")) {
