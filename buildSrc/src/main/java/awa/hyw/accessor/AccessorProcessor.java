...
import static awa.hyw.ASMUtil.checkcastFromObject;
import static awa.hyw.ASMUtil.checkcastToObject;

@Builder
public class AccessorProcessor implements Opcodes {
    private static final String ANNOTATION_PACKAGE = "awa.hyw/patchify/annotation";
    ...
    private final static String ASM_PACKAGE = "awa.hyw/patchify/asm";
